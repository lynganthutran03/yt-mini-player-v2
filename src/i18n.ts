...
const resources = {
  vi: {
    translation: {
      ...
      local: { library: 'Thư viện nhạc', refresh: 'Làm mới thư viện', allMusic: 'Tất cả nhạc', playFolder: 'Phát folder', playNextFolder: 'Tự phát folder tiếp theo sau khi chọn', name: 'Tên', type: 'Loại', folder: 'Folder', chooseFolder: 'Chọn một folder để bắt đầu phát nhạc.', noMusicFolders: 'Không tìm thấy folder nhạc nào trong Windows Music.', seekDisabled: 'Không hỗ trợ tua nhạc trên máy', tracks: '{{count}} bài' },
  ...
  en: {
    translation: {
      ...
      local: { library: 'Music library', refresh: 'Refresh library', allMusic: 'All music', playFolder: 'Play folder', playNextFolder: 'Play next folder automatically', name: 'Name', type: 'Type', folder: 'Folder', chooseFolder: 'Select a folder to start playing music.', noMusicFolders: 'No music folders were found in Windows Music.', seekDisabled: 'Seeking is unavailable for local music', tracks: '{{count}} tracks' },
